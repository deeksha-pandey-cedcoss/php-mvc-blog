...
<body>
  ...
  if (isset($_COOKIE['login'])) {
    echo "<li class='link-item'><a href='../Controller/logout.php' class='link'>logout</a></li>";
    echo "<li class='link-item'><a href='/' class='link'>Home</a></li>";
    echo "<li class='link-item'><a href='../View/myblog.php' class='link'>My Blogs</a></li>";
    echo "<li class='link-item'><a href='../View/admin.php' class='link'>Admin</a></li>";
  } else {
    echo "<li class='link-item'><a href='../View/signup.php' class='link'>Login</a></li>";
    echo "<li class='link-item'><a href='/' class='link'>Home</a></li>";
  }
  ?>
  ...
  <br>
  <!-- end slideshow -->
  <!-- button to start writinh your own blog -->
  <?php

  if (isset($_COOKIE['login'])) {
    echo "<div class='text-center'>
  <button type='button' class='btn btn-secondary'><a href='../View/blog.php' class='link'>Create</a></button>
</div>";
  }
  ...
  foreach ($result as $key => $value) {
    ...
    echo "<a href='../Controller/like.php?blog_id=" . $result[$key]->id .
    "& user_id=" . $_COOKIE['login'] . " class='btn dark''>
